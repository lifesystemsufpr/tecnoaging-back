...
def processar_sts(payload: Dict[str, Any]):
  try:
    ...
    df_out = pd.DataFrame({
      ...
      "Tempo total (s)": tempos_ciclo_cel,
      "Tempo levantar (s)": tempos_levantar_cel,
      "Tempo sentar (s)": tempos_sentar_cel,
      "Frequência (Hz)": hz_ciclos_cel,
      "Transição em pé (s)": tempos_em_pe_cel,
      "Transição sentado (s)": tempos_sentado_cel,
      ...
      "Tempo Pico 1 (s)": cel_pico1_tempo,
      "Tempo Pico 2 (s)": cel_pico2_tempo,
      "Valor Pico 1 (°)": cel_pico1_val,
      "Valor Pico 2 (°)": cel_pico2_val,
